                    ...
                    <div class="blog-inner-details-page">
                        <div class="blog-inner-box">
                            <div class="side-blog-img">
                                <img class="img-fluid" src="{{ asset('frontend/images/inner-blog-img.jpg') }}"
                                    alt="">
                            ...
                            <div class="recent-post-box">
                                <div class="recent-box-blog">
                                    <div class="recent-img">
                                        <img class="img-fluid" src="{{ asset('frontend/images/post-img-01.jpg') }}"
                                            alt="">
                                    </div>
                                ...
                                <div class="recent-box-blog">
                                    <div class="recent-img">
                                        <img class="img-fluid" src="{{ asset('frontend/images/post-img-02.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="recent-info">
                                        <ul>
                                ...
                                <div class="recent-box-blog">
                                    <div class="recent-img">
                                        <img class="img-fluid" src="{{ asset('frontend/images/post-img-03.jpg') }}"
                                            alt="">
                                    </div>
                                    <div class="recent-info">
                                        <ul>
