...
<body style="padding: 0 20px;">
    <header style="text-align: center; padding: 10px 0;">
        <h2>Mie Jablay</h2>
        <h2 style="color: blue;">Jurnal Kas Masuk</h2>
        <span
            style="color: chocolate; line-height: 25px;">{{ \Carbon\Carbon::make($first_date)->translatedFormat('d M Y') }}
            - {{ \Carbon\Carbon::make($end_date)->translatedFormat('d M Y') }}</span>
    </header>
    <table>
        <tr>
