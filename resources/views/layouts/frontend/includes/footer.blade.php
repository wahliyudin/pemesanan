                    ...
                    <div class="carousel-inner mt-4">
                        <div class="carousel-item text-center active">
                            <div class="img-box p-1 border rounded-circle m-auto">
                                <img style="object-fit: cover;" class="d-block w-100 h-100 rounded-circle"
                                    src="{{ asset('users/WhatsApp Image 2022-05-30 at 09.15.53.jpeg') }}" alt="">
                            </div>
                            <h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Khaidar
                                    Bagir</strong>
                            </h5>
                        ...
                        <div class="carousel-item text-center">
                            <div class="img-box p-1 border rounded-circle m-auto">
                                <img style="object-fit: cover; object-position: top;"
                                    ...
                                    src="{{ asset('users/WhatsApp Image 2022-05-30 at 09.18.09.jpeg') }}" alt="">
                            </div>
                            <h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Enjel Putri
                                    Andini</strong>
                            </h5>
                        ...
                        <div class="carousel-item text-center">
                            <div class="img-box p-1 border rounded-circle m-auto">
                                <img style="object-fit: cover; object-position: center;"
                                    class="d-block w-100 h-100 rounded-circle"
                                    src="{{ asset('users/WhatsApp Image 2022-05-30 at 11.26.51.jpeg') }}" alt="">
                            </div>
                            <h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Siti Laela</strong>
                            </h5>
                            <h6 class="text-dark m-0">Web Designer</h6>
                            <p class="m-0 pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam
                                eu sem
                        ...
                        <div class="carousel-item text-center">
                            <div class="img-box p-1 border rounded-circle m-auto">
                                <img style="object-fit: cover; object-position: center;"
                                    class="d-block w-100 h-100 rounded-circle"
                                    src="{{ asset('users/WhatsApp Image 2022-05-19 at 23.14.59.jpeg') }}" alt="">
                            </div>
                            <h5 class="mt-4 mb-0"><strong class="text-warning text-uppercase">Wahliyudin</strong>
                            </h5>
                            <h6 class="text-dark m-0">Web Designer</h6>
                            <p class="m-0 pt-3">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam
                                eu sem
